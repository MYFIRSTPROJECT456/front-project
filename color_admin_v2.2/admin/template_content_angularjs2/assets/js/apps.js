...
/* Application Event Listener
------------------------------------------------ */
window.addEventListener('init-component', function(e) {
    App.initComponent();
});
window.addEventListener('sidebar-ready', function(e) {
    App.initSidebar();
    App.initComponent();
});
window.addEventListener('top-menu-ready', function(e) {
    App.initTopMenu();
});
window.addEventListener('theme-panel-ready', function(e) {
    App.initThemePanel();
});
window.addEventListener('page-boxed-layout', function(e) {
    $('body').addClass('boxed-layout');
});
window.addEventListener('clear-boxed-layout', function(e) {
    $('body').removeClass('boxed-layout');
});
window.addEventListener('page-bg-white', function(e) {
    $('body').addClass('bg-white');
});
window.addEventListener('clear-bg-white', function(e) {
    $('body').removeClass('bg-white');
});
window.addEventListener('page-pace-top', function(e) {
    $('body').addClass('pace-top');
});
window.addEventListener('clear-pace-top', function(e) {
    $('body').removeClass('pace-top');
});
window.addEventListener('page-without-header', function(e) {
    $('body, #page-container').addClass('p-t-0');
});
window.addEventListener('clear-without-header', function(e) {
    $('body, #page-container').removeClass('p-t-0');
});
window.addEventListener('page-reload', function(e) {
    $('.lightbox, .lightboxOverlay, .introjs-hints, #gritter-notice-wrapper, .jvectormap-tip, .tooltip, .ui-autocomplete, .typeahead, .colorpicker, .popover, .simplecolorpicker, .daterangepicker').remove();
});