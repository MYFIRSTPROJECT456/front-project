...
var handleChartJs = function() {
    var ctx = document.getElementById('chart-js-line-chart').getContext('2d');
    var lineChart = new Chart(ctx, {
        type: 'line',
        data: lineChartData
    });
    
    var ctx2 = document.getElementById('chart-js-bar-chart').getContext('2d');
    var barChart = new Chart(ctx2, {
        type: 'bar',
        data: barChartData
    });
    
    var ctx3 = document.getElementById('chart-js-radar-chart').getContext('2d');
    var radarChart = new Chart(ctx3, {
        type: 'radar',
        data: radarChartData
    });
    
    var ctx4 = document.getElementById('chart-js-polar-area-chart').getContext('2d');
    var polarAreaChart = new Chart(ctx4, {
        type: 'polarArea',
        data: polarAreaData
    });
    
    var ctx5 = document.getElementById('chart-js-pie-chart').getContext('2d');
    window.myPie = new Chart(ctx5, {
        type: 'pie',
        data: pieChartData
    });
    
    var ctx6 = document.getElementById('chart-js-doughnut-chart').getContext('2d');
...
var ChartJs = function () {
    ...
    return {
        //main function
        init: function () {
            $.getScript('assets/plugins/chart-js/Chart.min.js').done(function() {
                handleChartJs();
            });
        }
    };
